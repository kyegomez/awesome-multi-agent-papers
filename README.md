...
- **Octopus v4: Graph of language models**
   Wei Chen, Zhiyuan Li
   arXiv.org 2024
   [open paper page](https://api.semanticscholar.org/CorpusId:269457073)
   <details>
     <summary> Abstract </summary>
